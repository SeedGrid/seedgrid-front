...
export type SgCurrencyEditProps = {
  id: string;
  label?: string;
  labelText?: string;
  hintText?: string;
...
type SgCurrencyEditBaseProps = Omit<SgCurrencyEditProps, keyof RhfFieldProps> & {
...
function SgCurrencyEditBase(props: SgCurrencyEditBaseProps) {
...
export function SgCurrencyEdit(props: SgCurrencyEditProps) {
  ...
  return <SgCurrencyEditBase {...rest} />;
}
