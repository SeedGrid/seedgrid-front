...
const DEFAULT_LABELS: SignupLabels = {
  ...
  disclaimer: "Ao continuar, voc� confirma que as informa��es fornecidas s�o verdadeiras.",
  submit: "Criar conta"
};
        ...
        >
          <section className="space-y-6">
            <div>
              ...
              <p className="text-sm text-foreground/60">Use o dom�nio e as informa��es fiscais oficiais.</p>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-12">
                ...
                return (
                  <div className="space-y-1 sm:col-span-4">
                    <SgInputCNPJ
                      ...
                      lengthMessage="CNPJ deve ter 14 d�gitos."
                      invalidMessage="CNPJ inv�lido."
                      inputProps={{
                        ...cnpjRegister,
                        onBlur: async (event) => {
              ...
              <div className="sm:col-span-8">
                <SgInputText
                  ...
                  inputProps={register("corporateName", { required: "Informe a raz�o social." })}
                />
              </div>
              ...
              <div className="grid gap-4 sm:grid-cols-12">
                {(() => {
                  ...
                  return (
                    <div className="space-y-1 sm:col-span-2">
                      ...
                      />
                      <p className="text-xs text-foreground/50">Ao digitar o CEP, buscamos o endere�o.</p>
                    </div>
                  );
                })()}
                ...
                <div className="sm:col-span-3">
                  <SgInputText
                    ...
                    inputProps={register("address.number", { required: "Informe o n�mero." })}
                  />
                </div>
                ...
                <SgInputPhone
                  ...
                  lengthMessage="Telefone inv�lido."
          ...
          <SgGroupBox title="Respons�vel legal" className="mt-6">
            <div className="grid gap-4 sm:grid-cols-12">
              <div className="sm:col-span-3">
                <SgInputCPF
                  id="legal-cpf"
                  ...
                  lengthMessage="CPF deve ter 11 d�gitos."
                  invalidMessage="CPF inv�lido."
              ...
              <div className="sm:col-span-4">
                <SgInputPhone
                  ...
                  lengthMessage="WhatsApp inv�lido."
