    ...
    <SgStack className="max-w-6xl" gap={32}>
      ...
      >
        ...
        <SgStack className="mt-6">
          <SgCodeBlockBase
            code={loadSample("sg-panel-example-01.src")}
          />
        </SgStack>
      </Section>
      ...
      >
        ...
        <SgStack className="mt-6">
          <SgCodeBlockBase
            code={loadSample("sg-panel-example-02.src")}
          />
        </SgStack>
      </Section>
      ...
      <Section title="borderStyle + padding + children" description="Estilizacao basica do panel.">
        ...
        <SgStack className="mt-6">
          <SgCodeBlockBase
            code={loadSample("sg-panel-example-03.src")}
          />
        </SgStack>
      </Section>
      ...
      >
        ...
        <SgStack className="mt-6">
          <SgCodeBlockBase
            code={loadSample("sg-panel-example-04.src")}
          />
        </SgStack>
      </Section>
      ...
      <Section title="Snippet com todas as props" description="Resumo rapido de uso cobrindo toda a API do SgPanel.">
        <SgCodeBlockBase
          code={loadSample("sg-panel-example-05.src")}
        />
      </Section>
    </SgStack>
  );
