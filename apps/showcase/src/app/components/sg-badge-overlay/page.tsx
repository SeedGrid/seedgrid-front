...
export default function Example() {
  return (
    <>
      <SgBadgeOverlay placement="top-left" badge={<SgBadge value="TL" size="xs" variant="soft" />}><span>TL</span></SgBadgeOverlay>
      <SgBadgeOverlay placement="top-right" badge={<SgBadge value="TR" size="xs" variant="soft" />}><span>TR</span></SgBadgeOverlay>
      <SgBadgeOverlay placement="bottom-left" badge={<SgBadge value="BL" size="xs" variant="soft" />}><span>BL</span></SgBadgeOverlay>
      <SgBadgeOverlay placement="bottom-right" badge={<SgBadge value="BR" size="xs" variant="soft" />}><span>BR</span></SgBadgeOverlay>
    </>
  );
}`}
          />
