...
const STACK_PROPS: ShowcasePropRow[] = [
  { prop: "direction", type: "\"row\" | \"column\"", defaultValue: "column", description: "Direção principal do flex." },
  { prop: "gap", type: "number", defaultValue: "0", description: "Espaçamento entre itens." },
  { prop: "justify / align", type: "CSS justify/align", defaultValue: "-", description: "Distribuição e alinhamento dos itens." },
  ...
  { prop: "className / style", type: "string / CSSProperties", defaultValue: "-", description: "Customização visual do stack." }
];
    ...
    <I18NReady>
      ...
      >
        <ShowcaseStickyHeader
          ...
          title="SgStack"
          subtitle="Wrapper flex declarativo para direção, alinhamento, distribuição e espaçamento."
          exampleLinks={exampleLinks}
          onAnchorClick={handleAnchorClick}
        />

      <Section title="1) Column + Row" description="Exemplos comuns de layout com stack.">
...
<SgStack direction="row" justify="between" align="center">
  ...
  <SgButton size="sm">Confirmar</SgButton>
        ...
        <Section title="2) Playground (SgPlayground)" description="Teste rápido das props principais do SgStack.">
          <SgPlayground
            title="SgStack Playground"
            interactive
